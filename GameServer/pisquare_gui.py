...
class PiSquareGraphics:
    ...
    def drawLine(self, x1, y1, x2, y2, color = "black", pensize = 1):
    ...
    def fillCircle(self, x, y, radius, color = "black"):
    ...
    def fillRectangle(self, x, y, width, height, fillcolor, pensize = 3, pencolor = "black"):
        self.turtle.pensize(pensize)
    ...
    # Write the current average move time of each player
    def drawTimes(self, time1, time2):
        self.fillRectangle(70, -106, 300, 24, "white", 1, "white")
        self.turtle.penup()
        self.turtle.goto(70,-130)
        self.turtle.color("red")
        self.turtle.write("Av. move time = %.3f sec"%time1, align = 'left', font = ("Arial", 24, "bold"))
        self.fillRectangle(70, -201, 300, 24, "white", 1, "white")
        self.turtle.goto(70,-225)
        self.turtle.color("green")
        self.turtle.write("Av. move time = %.3f sec"%time2, align = 'left', font = ("Arial", 24, "bold"))
    ...
    def reportDraw(self, winnername, winnertime, losertime):
        self.fillRectangle(-300, 100, 600, 200, "white", 5)
        self.turtle.penup()
        self.turtle.goto(0,30)
        self.turtle.color("black")
        self.turtle.write("Score draw!", align = 'center', font = ("Arial", 24, "bold"))
        self.turtle.goto(0,0)
        self.turtle.write(winnername+" wins", align = 'center', font = ("Arial", 24, "bold"))
        self.turtle.goto(0,-30)
        self.turtle.write("%.3f versus %.3f seconds"%(winnertime,losertime), align = 'center', font = ("Arial", 24, "bold"))
